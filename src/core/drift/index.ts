...
export { getChangedFiles, getFileDiff, getCommitMessages, isGitRepository, getCurrentBranch, resolveBaseRef, resolveBaseRefDisclosed, classifyFile, validateGitRef } from './git-diff.js';
