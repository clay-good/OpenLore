...
const EXEMPT: { file: string; line: number; why: string }[] = [
  ...
  { file: 'src/pi/extension.ts', line: 441, why: 'loopback http:// health probe' },
  { file: 'src/pi/extension.ts', line: 539, why: 'loopback http:// daemon call' },
  { file: 'src/pi/extension.ts', line: 1312, why: 'loopback http:// health probe' },
  {
