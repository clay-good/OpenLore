...
const EXEMPT: { file: string; line: number; why: string }[] = [
  ...
  { file: 'src/pi/extension.ts', line: 448, why: 'loopback http:// health probe' },
  { file: 'src/pi/extension.ts', line: 546, why: 'loopback http:// daemon call' },
  { file: 'src/pi/extension.ts', line: 1319, why: 'loopback http:// health probe' },
  {
